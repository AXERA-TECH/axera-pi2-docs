...
下载完成后，SD卡烧写文件，如![图片描述](media/board/flash4.png)
...
![图片描述](media/board/usb_driver.png)
...
![图片描述](media/board/Type-C_download_button.png)

![图片描述](media/board/flash2.png)

步骤6：等待几分钟后，下载完成结果如下图所示：

![图片描述](media/board/flash3.png)
...
![图片描述](media/board/SD_flash.png)

2，点击`选择目标磁盘`按钮，选择对应的Micro SD存储卡作为目标存储设备

![图片描述](media/board/SD_flash1.png)

![图片描述](media/board/SD_flash2.png)

3，点击`现在烧录！`按钮开始烧录，待工具提示`烧录完成！`时，表示镜像烧录完成，可以关闭balenaEtcher并取出存储卡

![图片描述](media/board/SD_flash3.png)

![图片描述](media/board/SD_flash4.png)

![图片描述](media/board/SD_flash5.png)
...
![图片描述](media/board/SD_flash8.png)
...
![图片描述](media/board/SD_flash6.png)

![图片描述](media/board/SD_flash7.png)
...
![图片描述](media/board/type-C_debug.jpg)
...
- 当串口USB转接板首次插入电脑时，需要安装串口驱动；驱动安装完成后，设备管理器可正常识别串口端口，如下图所示：
  ...
  ![图片描述](media/board/Remote_Login_Serial.png)

- 打开`MobaXterm`工具，点击`Session`，然后选择`Serial`

- 配置端口号，例如`COM4`，实际使用的串口号以PC识别到的串口号为准。如下图所示：

  ![图片描述](media/board/Remote_Login_Serial_setting.png)
